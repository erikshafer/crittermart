...
public class CorsPolicyTests
{
    ...
    public CorsPolicyTests(OrdersAppFixture fixture) => _fixture = fixture;
    ...
    public async Task allows_the_storefront_origin()
    {
        await _fixture.Host.Scenario(_ =>
        {
            ...
            _.WithRequestHeader("Origin", OrdersAppFixture.SpaOrigin);
            _.Header("Access-Control-Allow-Origin").SingleValueShouldEqual(OrdersAppFixture.SpaOrigin);
            _.IgnoreStatusCode();
        });
    }
